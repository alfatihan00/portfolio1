...
const ArrowRight = ({handleClick2}) => {
  return (
    // <svg className='arrow-right-portfolio' onClick={handleClick2} width="97" height="97" viewBox="0 0 97 
    <svg className='arrow-right-portfolio' onClick={handleClick2} width="98" height="98" viewBox="0 0 98 98" fill="none" xmlns="http://www.w3.org/2000/svg">
