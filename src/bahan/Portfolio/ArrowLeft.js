...
const ArrowLeft = ({handleClick3}) => {
  return (
    <svg className='arrow-left-portfolio' onClick={handleClick3} width="97" height="97" viewBox="0 0 97 97" fill="none" xmlns="http://www.w3.org/2000/svg">
